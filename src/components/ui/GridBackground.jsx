  ...
  useEffect(() => {
    ...
    class Node {
      ...
      draw() {
        ...
        ctx.fillStyle =
          this.glowIntensity > 0
            ? `rgba(6,182,212,${0.5 + this.glowIntensity * 0.4})`
            : "rgba(14,165,233,0.3)";
        ctx.fill();
        ...
        if (this.glowIntensity > 0) {
          ...
          gradient.addColorStop(
            0,
            `rgba(6,182,212,${this.glowIntensity * 0.4})`
          );
          gradient.addColorStop(
            0.5,
            `rgba(59,130,246,${this.glowIntensity * 0.2})`
          );
      ...
      for (let row = 0; row <= rows; row++) {
        for (let col = 0; col <= cols; col++) {
          ...
          if (col < cols) {
            ...
            ctx.strokeStyle =
              glowFactor > 0
                ? `rgba(6,182,212,${0.25 + glowFactor * 0.65})`
